...
# Código atualizado com fontes limpas, regex de validação e nomes padronizados
scraper_code = dedent("""
    ...
    def formatar_nome_time(nome):
        # Padroniza nomes comuns (pode expandir conforme necessário)
        substituicoes = {
    ...
    def extrair_placar(texto):
        # Aceita apenas padrões como "1x0", "0x2", "10x11" etc.
...
# Salva o novo arquivo limpo e confiável
with open("/mnt/data/scraper_api_limpo.py", "w") as f:
    f.write(scraper_code)

"/mnt/data/scraper_api_limpo.py"
